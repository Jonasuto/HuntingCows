...
public class ControlJuego extends SimpleBaseGameActivity
{
    ...
    private mx.itesm.jcampos.huntingcows.AdministradorEscenas admEscenas;
    /*
    ...
    protected void onCreateResources() throws IOException {
        ...
        mx.itesm.jcampos.huntingcows.AdministradorEscenas.inicializarAdministrador(this, mEngine);
        // Obtenemos la referencia al objeto administrador
        admEscenas = mx.itesm.jcampos.huntingcows.AdministradorEscenas.getInstance();
        mx.itesm.jcampos.huntingcows.AdministradorMusica.inicializarAdministrador(mEngine, this);
    }
    ...
    protected Scene onCreateScene() {
        ...
        admEscenas.setEscena(mx.itesm.jcampos.huntingcows.TipoEscena.ESCENA_SPLASH);
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (keyCode==KeyEvent.KEYCODE_BACK) {
            if(admEscenas.getTipoEscenaActual()== mx.itesm.jcampos.huntingcows.TipoEscena.ESCENA_MENU) {
